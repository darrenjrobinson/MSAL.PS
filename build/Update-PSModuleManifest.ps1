...
$ModuleFileList = $ModuleFileList -replace '([\\/])net462([\\/])Microsoft.Identity.Client.', '$1!!!$2Microsoft.Identity.Client.' -replace '([\\/])netstandard2.0([\\/])Microsoft.Identity.Client.', '$1net462$2Microsoft.Identity.Client.' -replace '([\\/])!!!([\\/])Microsoft.Identity.Client.', '$1netstandard2.0$2Microsoft.Identity.Client.'
$ModuleFileList = $ModuleFileList -replace '([\\/])net462([\\/])Microsoft.Identity.Client.Desktop.', '$1!!!$2Microsoft.Identity.Client.Desktop.' -replace '([\\/])netcoreapp3.1([\\/])Microsoft.Identity.Client.Desktop.', '$1net462$2Microsoft.Identity.Client.Desktop.' -replace '([\\/])!!!([\\/])Microsoft.Identity.Client.Desktop.', '$1netcoreapp3.1$2Microsoft.Identity.Client.Desktop.'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAyaEMYx5xt8EeP
# RTHdw/gPaYukf1yKIUaq1Fs0VcmAlaCCISgwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# CzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIxeMPAlZ54FpF9QUa6Y
# 0Nit1lC0XpkawjVb1EYOmJVfMA0GCSqGSIb3DQEBAQUABIICAAeUAEsGZL2ZMRqO
# 5xyBV5oAfXs3jZMQDuJJiV0RUv0inha/I9mSs6zB6/vIiTg8L8umk6EqQ6NoTEC4
# OnyOKkNeRvnXFE09uSEhfoO71WvdyP+moesfgNkHDyG8BUbmjQwVZaUBzw3df+6q
# gGvzDAJDzH4Dp6pynQ5qSdbH+9MQKcs+8A45u3uOWQBZK3n+IZoWqfQkYng5aT8t
# LQB/KmeHzVRRJmtZz7dxkp4EVVhm/65DOJMXJxDFGsStgcgnwqxwTTHAq+6Se31O
# EMVdIQGjhKp4pZfv2nizc786jm3vZCzFtzRiG7JqjPt/U5zpi8JIcuq2hqio9RzA
# B54MpidAAYbTojui+s8YVVcl6/4zLNGZ1VpqcdpaNDS41rMzNiaCiHf2RGaxuOP2
# BukxiqKEOfrejnxCuEfG/zCafVQAdY7wiqFBjOwFT02+1iLy+2FztsMmhfoNvtIs
# Q1fWkZXyGw8EBwhZwR+BLxak2U6WcF6pSD2dUja5r2NzLt3A7/8UDj8qqJWE0E3v
# W+QkquYWr6TuyHvBuR+Gxgq665JkYJZVADopE6/4/kC0ippfsiuLQWAj+xcp01ej
# pREvSCBRr4SfL6Xf+dw2/7bCuQTY+1nSfrYqKLrIyOz+u68G7vgR+GFyid6AR8W9
# ToI3FKuBYwFLY6Q63sBOkm5DItGIoYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJ
...
# NDQzMFowLwYJKoZIhvcNAQkEMSIEILnRATgRbrAPWub/sia2UWGPBG9FswH4TLNd
# xVzyYi70MA0GCSqGSIb3DQEBAQUABIICAK/obFOBC9Kdxk/ipu90CcvFte6yU0dd
# oUKTQGM5Z3lcjxgGLQel5A5VI5Zo3pxbCR/C8SKBBbVx7d2BaidvZeFBnGmFNu8l
# i66FgCXX/sZHw5RGGEv4qxgYed9cTZ1RY+k1b10LuriK4hTKOKQWZH4ZU6zBqZEy
# dxy774bXaXXXFJWQm5/T7blsVpeWtiDtN5845sc3j7eztPKuQ3Mv76vk3dq/9N0s
# 1Q9f7ndso6isUxG2CzcqkuQk65LektY14UNUTFZyj1DdbcdoKwArq8PiM5LK5o53
# //iAuWW+/rnDKPxVIVN0pRPL6mayd3kNOHL2sXZF+pjyVr4vAXelHp3xbz4hR5JS
# b/lZXYU1wXTOCxSciFP4v/sAfjo+gYhjt8ApnoyYk/CytfjOawzLOr4ePJ0gzvIQ
# ihLpEffsAFMOCa087DVi26UwkPHv7zDjKB+g83Hpyjw9xLR8m9oqmjZ+ha9Qn2Ch
# cQ4ViDA0kH8lJoczaDqDuFukS7OADaL52mI5hIN6gtEdL+XZMZCvfOxK/tKQ0mJB
# hHAQHBpu8TL9TEh8Ppxu7IRbSscjBLyleNtsN+wu4UOs4vkFAXwd591RUkBH98/D
# yitU+o9GOym2kxTRk9eI5GcPIceWvmCZqAGdwhFJ8fZe9XRwXRY143nqw/I2uu7Z
# MrPMFEjHLwyx
