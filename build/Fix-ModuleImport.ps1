# Save this as Fix-ModuleImport.ps1

param (
    [Parameter(Mandatory = $false)]
    [string] $ModulePath = ".\build\release\MSAL.PS\4.59.0"
)

# Path to the MSAL.PS.ps1 file
$psalPs1Path = Join-Path $ModulePath "MSAL.PS.ps1"

# Read the existing content
$content = Get-Content $psalPs1Path -Raw

# Create replacement content for DLL loading - using a different approach to avoid nested heredocs
$replacementCode = @'
...
function Catch-AssemblyLoadError {
    ...
    Write-Warning ("Assembly with same name `"{0}`" is already loaded:`n{1}" -f $AssemblyName, $Assembly.Location)
...
## Set paths to our custom build structure
...
## Based on PS version, load appropriate DLLs
...
if ([System.Environment]::OSVersion.Platform -eq "Win32NT") {
    $srcTokenCacheHelper = Join-Path $PSScriptRoot "internal\TokenCacheHelper.cs"
    if (Test-Path $srcTokenCacheHelper) {
        ...
        try {
            ...
            Write-Warning "There was an error loading TokenCacheHelper: $_"
        }
    }
}

## Load DeviceCodeHelper
$srcDeviceCodeHelper = Join-Path $PSScriptRoot "internal\DeviceCodeHelper.cs"
if (Test-Path $srcDeviceCodeHelper) {
    $dllRequirements = $RequiredAssemblies + @("System.Console.dll")
    try {
        Add-Type -LiteralPath $srcDeviceCodeHelper -ReferencedAssemblies $dllRequirements -IgnoreWarnings -WarningAction SilentlyContinue
    }
    catch {
...
# Replace everything from beginning to "## Load DeviceCodeHelper"
$newContent = $content -replace "(?s)#region Import Helper Functions.*?DeviceCode parameter will not function\.", $replacementCode

# Save the modified file
Set-Content -Path $psalPs1Path -Value $newContent

Write-Host "Modified MSAL.PS.ps1 to use custom DLL paths" -ForegroundColor Green
Write-Host "Try importing the module again with:" -ForegroundColor Cyan
Write-Host "Import-Module $ModulePath\MSAL.PS.psd1 -Force" -ForegroundColor Cyan

# SIG # Begin signature block
# MIIoJQYJKoZIhvcNAQcCoIIoFjCCKBICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAhzrf4tMfuojMs
# AmoiVvFMvqRrOcB8wehf8gtReA7NH6CCISgwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# CzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKOTkx/+o75IaL5cSwfM
# vx730meABV0xmAFpVDDYS2YAMA0GCSqGSIb3DQEBAQUABIICAKP4NEkeHEYOPfnj
# aehSNgTnKOd7VkEFn8ASVxk9Yl/EMwOoeqGcoCKrFYA7Rql3ZNHXo3k+BNmUzruP
# c7gdjpDhi0eHKVt66Zoa4nu2hgjcFH38TgguPRRQBXynv+GvCLOzTLL09LH7FISC
# rT/bdObPa5fPe2zpqI+BYWaj4aI71NwqRpqdenzUBZvSCKOjDJIRArhafNk73okx
